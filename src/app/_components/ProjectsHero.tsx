...
export default function ProjectsHero() {
  ...
  return (
    <div ref={wrapperRef} className="relative min-h-screen w-full overflow-hidden bg-white">
      <div data-prj-bg="" className="pointer-events-none absolute inset-0 origin-center bg-[#f0f0f0]" />
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 text-center md:px-8">
        <p data-prj-label="" className="mb-4 font-[family-name:var(--font-geist-mono)] text-sm uppercase leading-[1.1] text-black/50">
          [ Selected Work ]
        </p>
